...
#debugexec(getplaces)
#debugexec(getkeys_of_place, 2)
#debugexec(getclubs)
#debugexec(place_key, "11145", 2, 1, 3)
#debugexec(get_accessible_held_keys, "11145")
#debugexec(get_keys_held, "111703333")
#debugexec(valid_places_for_key, 2, 1)
debugexec(transfer_key, 11450, 2, 1)
